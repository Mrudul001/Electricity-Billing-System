...
def search():
    ...
    chk=0
    con=c.connect(host="localhost",user="root",passwd="admin",database="electricitybill")
    cursor=con.cursor() 
    srch2=srch.get()
...
mydb = mysql.connector.connect (host="localhost", user="root", passwd="admin", database="electricitybill")
cursor = mydb.cursor()
#====================================================================Tkinter Frame============================================
root= tk.ThemedTk()
root.get_themes()                 
